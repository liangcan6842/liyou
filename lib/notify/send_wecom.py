...
# -*- coding: utf-8 -*-
"""
# @Time   : 2022/10/26 17:59
# @Author : 梁灿
描述: 发送企业微信通知
"""

import requests
from lib.logging_tools.log_control import ERROR
from lib.other_tools.allure_data.allure_report_data import TestMetrics, AllureFileClean
from lib.times_tools.time_control import now_time
from lib.other_tools.get_local_ip import get_host_ip
from lib.other_tools.exceptions import SendMessageError, ValueTypeError
