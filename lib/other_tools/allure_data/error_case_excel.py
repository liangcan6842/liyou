...
# TODO 还需要处理动态值
class Errortest_case:
    """ 收集错误的excel """
    def __init__(self):
        self.test_case_path = ensure_path_sep("\\report\\html\\data\\test_cases\\")
...
class ErrorCaseExcel:
    ...
    def __init__(self):
        _excel_template = ensure_path_sep("\\lib\\other_tools\\allure_data\\自动化异常测试用例.xlsx")
