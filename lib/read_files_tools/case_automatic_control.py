...
# -*- coding: utf-8 -*-
"""
# @Time   : 2022/10/26 19:14
# @Author : 梁灿
"""
import os
from typing import Text, Dict
from common.setting import ensure_path_sep
from lib.read_files_tools.testcase_template import write_test_case_file
from lib.read_files_tools.yaml_control import GetYamlData
from lib.read_files_tools.get_all_files_path import get_all_files
from lib.other_tools.exceptions import ValueNotFoundError


class test_caseAutomaticGeneration:
    ...
    def get_case_path(self, file_path: Text) -> tuple:
        ...
        # 判断生成的 test_case 文件名称，需要以test_ 开头
    ...
    def allure_epic(case_data: Dict, file_path) -> Text:
        ...
        try:
            ...
            raise ValueNotFoundError(test_caseAutomaticGeneration.error_message(
