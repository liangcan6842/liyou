...
from lib.other_tools.models import RequestType
from lib.logging_tools.log_decorator import log_decorator
from lib.mysql_tools.mysql_control import AssertExecution
from lib.logging_tools.run_time_decorator import execution_duration
from lib.other_tools.allure_data.allure_tools import allure_step, allure_step_no, allure_attach
from lib.read_files_tools.regular_control import cache_regular
from lib.requests_tools.set_current_request_cache import SetCurrentRequestCache
from lib.other_tools.models import TestCase, ResponseData
...
class RequestControl:
    ...
    def http_request(
        ...
        :return:
        """
        from lib.requests_tools.dependent_case import DependentCase
