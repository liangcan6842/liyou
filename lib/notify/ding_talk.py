...
from lib.other_tools.get_local_ip import get_host_ip
from lib.other_tools.allure_data.allure_report_data import AllureFileClean, TestMetrics
...
class DingTalkSendMsg:
    ...
    def send_feed_link(self, *args) -> None:
        """发送feed_link"""

        self.xiao_ding().send_feed_card(list(args))
